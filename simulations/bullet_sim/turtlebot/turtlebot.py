...
class Turtlebot(WheeledMobileRobot):
    ...
    def __init__(self,
                 ...
                 dt: float = 0.1,
                 **kwargs):
        super().__init__(gui=gui, debug=debug, init_state=init_state, dt=dt, **kwargs)
        # set the init state
        self.nState = 3
        self.nControl = 2
        ...
        p.resetDebugVisualizerCamera( cameraDistance=3, cameraYaw=30, cameraPitch=52, cameraTargetPosition=self.init_state)
        params = p.getDebugVisualizerCamera()
        p.resetDebugVisualizerCamera(params[10], params[8], params[9], np.array(self.init_state))
    ...
    def step(self, action):
        ...
        p.resetDebugVisualizerCamera( cameraDistance=3, cameraYaw=30, cameraPitch=52, cameraTargetPosition=self.state)
