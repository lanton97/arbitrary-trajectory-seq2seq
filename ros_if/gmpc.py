...
import casadi as ca
import math
from ros_if.pid_stub import PIDStub
from ros_if.se2 import SE2
from ros_if.transformations import global2LocalCoords
...
class GeometricMPC:
    ...
    def set_control_bound(self, v_min = -1.5, v_max= 1.5, w_min = -1.5, w_max= 1.5, dv_max=0.8, dw_max=0.5):
        self.v_min = v_min
        self.v_max = v_max
        self.w_min = w_min
        self.w_max = w_max
