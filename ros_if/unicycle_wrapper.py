...
from ros_if.se2 import *
from ros_if.util import *
from ros_if.transformations import *
...
class UnicycleWrapper:
    ...
    def inverseTransform(base, observed):
        ...
        rotation = np.array([[rotation[0,0], rotation[1,0], rotation[0,2]],
                                [rotation[0,1], rotation[1,1], rotation[1,2]],
                                [0,             0,             1            ]])
