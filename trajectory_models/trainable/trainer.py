...
class modelTrainer():
    ...
    def train(self, train_dataloader, device, val_dataloader=None, epochs=100, lr=0.001, gamma=0.995, l2_reg=0.000, debug=False, save_path=None, loss=BoxMinusMatNLLLoss, cov_targets=False):
